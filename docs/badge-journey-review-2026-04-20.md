...
| Sprint C c5/5 — backoffice widget UI                       | **queued (frontend PR)**      | `/checkin/anomalies` + `/checkins` server side ready; the widget that renders them lives in `apps/web-backoffice` and ships as its own PR.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
