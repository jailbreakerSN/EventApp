...
/**
 * Organizer overhaul — Phase O4. Configuration › Sessions sub-page.
 */

import { useParams } from "next/navigation";
import { Skeleton, QueryError } from "@teranga/shared-ui";
import { useEvent } from "@/hooks/use-events";
import { SessionsTab } from "../../_event-shell/event-detail-content";

export default function ConfigurationSessionsPage() {
  ...
  return <SessionsTab eventId={eventId ?? ""} eventStatus={event.status} />;
}
