...
export default async function LegalPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <h1 className="text-3xl font-bold tracking-tight mb-2">Mentions l&eacute;gales</h1>
      <p className="text-sm text-muted-foreground mb-10">Dernière mise à jour : 9 avril 2026</p>
      ...
      <div className="space-y-8 text-foreground leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-none pl-0 mt-3 space-y-1">
            ...
            <li>
              <strong>Siège social :</strong> 1600 Amphitheatre Parkway, Mountain View, CA 94043,
              États-Unis
            </li>
            <li>
          ...
          <p className="mt-2">
            Les données sont stockées dans des centres de données situés en Europe (région
            europe-west1), conformément aux clauses contractuelles standard de Google relatives à la
        ...
        <section>
          ...
          <p>
            ...
            adaptation de tout ou partie du site, quel que soit le moyen ou le procédé utilisé, est
            interdite sans l&apos;autorisation écrite préalable de Teranga Events.
          </p>
        </section>
